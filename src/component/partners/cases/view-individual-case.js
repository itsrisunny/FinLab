...
const CaseNumberInLead = () => {
  ...
  const handleClosePesonalDetails = () => { setPersonalDetails(false); };
  ...
  const getUserData = () => {
    ...
    axios.post(API_URL + "admin/get-user-loan-appication", formData).then((res) => {
      ...
      if (response?.status === 200) {
        ...
        let created_by = "";
        if (resp?.user_detail?.user_id == resp?.loan_requirement?.created_by || resp?.loan_requirement?.created_by == null) {
          created_by = "FinLab";
        } else {
          created_by = "Partner";
        }
...
const [ProfessionDataDropDown,setProfessionDataDropDown]=useState([])
  ...
  const verifyAadharNo = (e) => {
    if (((e.target.value).replace(/ /g, '')).length > 11) {
      axios.post(API_URL + "api-auth/verify-aadhar-number-v3", { uid: e.target.value }).then((res) => {
        if (res?.data?.data != undefined) {
          let response = res.data;
  ...
  const downloadData = () => {
    ...
    a = v.uploadAadhaarFront ? dataUrlList.push(API_URL + v.uploadAadhaarFront) : "";


    a = v.uploadAadhaarBack ? dataUrlList.push(API_URL + v.uploadAadhaarBack) : "";


    a = v.uploadDirectorKyc ? dataUrlList.push(API_URL + v.uploadDirectorKyc) : "";


    a = v.uploadPartnershipDeed ? dataUrlList.push(API_URL + v.uploadPartnershipDeed) : "";


    a = (v?.uploadSalarySlip.length) ? v?.uploadSalarySlip.map((k, j) => (
      dataUrlList.push(API_URL + k))) : "";

    a = (v?.uploadItr.length) ? v?.uploadItr.map((k, j) => (
      dataUrlList.push(API_URL + k))) : "";
              ...
              <div className='mainContent'>
                <div className="main-body">
                  ...
                  <div className="col-md-12 moveRight" >
                    <button className='btn-danger' style={{ height: '2rem' }} onClick={handleBackButton}><i className="fa fa-arrow-left" aria-hidden="true"></i></button>
                        ...
                        <div className="card mb-3">
                          ...
                          <div className="card-body">
                            <div className='custom-cardHead'>
                              ...
                              <button className="btn btn-primary" onClick={handleAddDirector} >Add Director<i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                            </div>
                                ...
                                {v.directorData?.length ? v.directorData.map((row, index) => (
                                  <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                                    ...
                                    <td className="table-body">
                                      ...
                                      <button className="btn btn-primary" onClick={() => editDirectorDetails(row)} disabled={isDisableAll}>Edit</button>
                                  ...
                                  <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                                    ...
                                    {acceptedOffers.length && acceptedOffers.includes(row.id) ?
                                      ...
                                      <td className="table-body">
                                        ...
                                        <button className="btn btn-primary" onClick={(e) => { editData(row) }} disabled={isDisableAll}>Edit</button>
                                  ...
                                  {v.bankDetails?.length ? v.bankDetails.map((row, index) => (
                                    <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                                      ...
                                      <td className="table-body">
                                        ...
                                        <button className="btn btn-primary" onClick={() => EditBankDetails(row, row.account_number)} disabled={isDisableAll}>Edit</button>
              ...
              <div className="inner-employement">
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <select value={subLoanPurpose} className={"salary-input"} onChange={(e) => { handleSubLoanPurpose(e) }} >
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <InputMask mask="9999" maskChar="" name={"tenure"} className={"salary-input"} value={loanDuration} placeholder="72 Months" onChange={(e) => { handleDuration(e) }} />
              ...
              <div className="inner-employement">
                ...
                <div className="form-group loan-in row" style={{ "display": (iFile == "none" ? "none" : "") }}>
                  <div className="col-md-6 spacing" style={{ "display": ((iFile == "gstin" || iFile == "both") ? "" : "none") }}>
                    ...
                    <div className="loan-in">
                      <InputMask mask="99aaaaa9999a9a*" maskChar="" className={gstinError ? "salary-input error" : "salary-input"} placeholder="22AAAAA0000A1Z5" value={gstin} onChange={handleGstin} />
            ...
            <>
              <div className="inner-employement">
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    <label>Pan Number</label>
                    <InputMask mask="aaaaa9999a" maskChar="" className={dirPanNoError ? "salary-input error" : "salary-input"} placeholder="AZSPT5997H" onChange={handleDirPanNumber} onKeyUp={validateDirPanNumber} value={dirPanNo} />
                  </div>
                  <div className="col-md-6 spacing">
                    <label>Director Name</label>
                    <input type="text" className={dirNameError ? "salary-input error" : "salary-input"} onChange={handleDirName} value={dirName} />
                  </div>
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <InputMask mask="9999 9999 9999" maskChar="" type="tel" className={aadhaarError ? "salary-input error" : "salary-input"} placeholder="9999 9999 9999" value={aadhaar} onKeyUp={verifyAadharNo} onChange={handleAadhaar} />
                  </div>
