...
const LeadCase = () => {
    ...
    const expectedHeaders = ["Loan Purpose", "Sub Loan Purpose", "Loan Amount", "Duration", "Employement Type", "Business Type", "Profession", "Name", "Mobile Number", "Email ID", "PAN Number", "Date Of Birth", "Date of Incorporation", "Address 1", "Address 2", "Landmark", "PIN Code","City, District", "State", "Ifile", "GST Number", "Turnover Yearly", "Gross Annual Profit", "Industry", "Sub Industry"];
    useEffect(() => {
      getLoanData(offset)
    },[offset])
        ...
        <div className="topHeadings">
          <h3>Lead cases</h3>
                ...
                <button className="btn btn-primary"style={{"marginRight":"3px"}} onClick={() => uploadDetails()}>Bulk Upload</button>
                 <span><Link to="/partners-admin/add/case" className="btn btn-success">Create New</Link></span>
