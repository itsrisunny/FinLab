		...
		if(handleValidation()){
			...
			axios.post(API_URL+"token/generate-token",{user_id: "0"}).then((res) => {
                ...
                if(response?.token){
					...
					axios.post(API_URL+"partners-admin/reset-password",jsonFormData).then((res) => {
						let response = res.data;
										...
										<div className="card-body">
											...
											<div className="login-fields">
												...
												<div className="form-group form-check">
											    	...
											    	<label className="form-check-label" style={{"float": "right","paddingBottom": "10px"}}><Link to="/partners/login">Back to login</Link></label>
											    </div>
