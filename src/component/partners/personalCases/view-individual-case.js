...
const CaseNumberInLead = () => {
    ...
    axios.post(API_URL + "admin/get-user-loan-appication", formData).then((res) => {
      ...
      if (response?.status === 200) {
        ...
        setData([{
          ...
          currentAddress: {
            address1: resp?.personal_detail?.current_address_1 ? resp?.personal_detail?.current_address_1 : "",
            address2: resp?.personal_detail?.current_address_2 ? resp?.personal_detail?.current_address_2 : "",
            landmark: resp?.personal_detail?.current_landmark ? resp?.personal_detail?.current_landmark : "",
            pincode: resp?.personal_detail?.current_pin_code ? resp?.personal_detail?.current_pin_code : "",
            state: resp?.personal_detail?.current_state ? resp?.personal_detail?.current_state : "",
            city: resp?.personal_detail?.current_city ? resp?.personal_detail?.current_city : "",
          },
          ...
          aadhaar: resp?.personal_detail?.aadhaar?resp?.personal_detail?.aadhaar:"-",
          salariedCompInfo: {
            name: resp?.salaried_detail?.company_name?resp?.salaried_detail?.company_name:"-",
            tenure: resp?.salaried_detail?.compnay_tenure?resp?.salaried_detail?.compnay_tenure:"-",
            fixedSalary: resp?.salaried_detail?.net_fixed_salary?resp?.salaried_detail?.net_fixed_salary:"-",
            comapnyEmail: resp?.salaried_detail?.official_email_id?resp?.salaried_detail?.official_email_id:"-",
            totalExp: resp?.salaried_detail?.total_experience?resp?.salaried_detail?.total_experience:"-",
            workingAs: resp?.salaried_detail?.working_as?resp?.salaried_detail?.working_as:"-",
            noticePeriod: resp?.salaried_detail?.are_serving_notice_period?resp?.salaried_detail?.are_serving_notice_period:"-",
            salaryRecievedVia: resp?.salaried_detail?.salary_recieved_via?resp?.salaried_detail?.salary_recieved_via:"-",
          }
        }]);
  ...
  const UpdateEmployementDetailsData = () => {
    if(handleValidation()){
      axios.post(API_URL+"token/generate-token",{user_id: caseID}).then((res) => {
        let response = res.data;
        if(response?.token){
          let jsonData = {
            case_id: caseID,
          ...
          axios.post(API_URL+"user/salired-detail",jsonData).then((res) => {
            let response = res.data;
            if (response?.status === 200) {
              toast.success(response?.message);
  ...
  const handleDocumentsValidation = () => {
    ...
    if (panFile.length || bankStatement.length || formSixteen.length || formSixteenP.length) {
      isFormValid = true;
    } else {
      isFormValid = false;
    }
              ...
              {loader ? <Loader display={"flex"} /> :
                <div className="main-body">
                  ...
                  <button className='btn-warning' style={{ height: '2rem' }} onClick={handleBackButton}><i className='fa fa-arrow-left' aria-hidden="true"></i></button>
                    {
                      (isVerified == 0 && type == 1)?<><span> <button className="btn btn-warning" onClick={handleVerifyPanGstin}>Verify PAN</button></span></>:""
                    }
                      ...
                      <h5 className='case-heading'>Personal details</h5>
                        <div className="card-body">
                          ...
                          <div className="row" >
                            ...
                            <div className="col-sm-8 text-secondary">{v.panNumber ? v.panNumber : ""} &nbsp;{v?.is_pan_verified?<img src={verifiedImage} alt="verified" style={{"height":"13px"}}/>:""}</div>
                          </div>
                          <div className="row" >
                            <div className="col-sm-4">
                              <h6>Aadhaar Number:</h6>
                            </div>
                            <div className="col-sm-8 text-secondary">{v.aadhaar ? v.aadhaar : ""} &nbsp;{v?.is_pan_verified && v.aadhaar != "-"?<img src={verifiedImage} alt="verified" style={{"height":"13px"}}/>:""}</div>
                          </div>
                          <div className="row" >
                            <div className="col-sm-4">
                              <h6>Date of birth:</h6>
                            </div>
                            <div className="col-sm-8 text-secondary">{v.dateOfBirth ? moment(v.dateOfBirth, "YYYY-MM-DD hh:mm:ss").format("DD/MM/YYYY") : ""}</div>
                          </div>
                          <div className="row" >
                            <div className="col-sm-4">
                              <h6>Gender:</h6>
                            </div>
                            <div className="col-sm-8 text-secondary">{v.gender ? v.gender : ""}</div>
                          </div>
                          <div className="row" >
                            <div className="col-sm-4">
                              <h6>Relationship Status:</h6>
                            </div>
                            <div className="col-sm-8 text-secondary">{v.relationship_status ? v.relationship_status : ""}</div>
                          </div>
                          <div className="row">
                            <div className="col-sm-4">
                          ...
                          <div className="row">
                            ...
                            <div className="col-sm-8 text-secondary">
                              {v.currentAddress.address1 ? v.currentAddress.address1 + ", " : ""}{v.currentAddress.address2 ? v.currentAddress.address2 + ", " : ""}{v.currentAddress.landmark ? v.currentAddress.landmark + ", " : ""}
                              {v.currentAddress.city ? v.currentAddress.city + ", " : ""}{v.currentAddress.state ? v.currentAddress.state + ", " : ""}{v.currentAddress.pincode}
                            </div>
                          </div>
                          <div className="row" >
                            <div className="col-sm-4">
                            ...
                            <div className="col-sm-8 text-secondary">{v.pastLoan ? v.pastLoan : ""}</div>
                          </div>
                          <div className="row" >
                            <div className="col-sm-4">
                              <h6>EMI you are paying currently :</h6>
                            </div>
                            <div className="col-sm-8 text-secondary">{v.pastLoanAmount && v.pastLoan == "Yes" ? <CurrencyFormat value={v.pastLoanAmount} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</div>
                            ...
                            <div className='col-md-6'> 
                              <div className="row" >
                                ...
                                <div className="col-sm-6 text-secondary">{v.salariedCompInfo?.name}</div>
                              ...
                              <div className="row" >
                                ...
                                <div className="col-sm-7 text-secondary">{v.salariedCompInfo?.tenure}</div>
                              </div>
                              ...
                              <div className="row" >
                                ...
                                <div className="col-sm-7 text-secondary">{v.salariedCompInfo?.fixedSalary ? <CurrencyFormat value={v.salariedCompInfo?.fixedSalary} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</div>
                              </div>
                              <div className="row" >
                                <div className="col-sm-5">
                                  <h6>Official Email ID:</h6>
                                </div>
                                <div className="col-sm-7 text-secondary">{v.salariedCompInfo?.comapnyEmail}</div>
                              </div>
                              <div className="row" >
                                <div className="col-sm-5">
                                  <h6>Total Experience:</h6>
                                </div>
                                <div className="col-sm-7 text-secondary">{v.salariedCompInfo?.totalExp}</div>
                              </div>
                              <div className="row" >
                                <div className="col-sm-5">
                                  <h6>Working as:</h6>
                                </div>
                                <div className="col-sm-7 text-secondary">{v.salariedCompInfo?.workingAs}</div>
                              </div>
                              <div className="row" >
                                <div className="col-sm-5">
                                  <h6>Notice Period:</h6>
                                </div>
                                <div className="col-sm-7 text-secondary">{v.salariedCompInfo?.noticePeriod}</div>
                              </div>
                              <div className="row" >
                                <div className="col-sm-5">
                                  <h6>Salary Received In:</h6>
                                </div>
                                <div className="col-sm-7 text-secondary">{v.salariedCompInfo?.salaryRecievedVia}</div>
                              </div>
          ...
          <div className="col-md-12 col-lg-12">
            ...
            <>
              <div className="inner-employement">
                  ...
                  <div className="col-md-6 spacing">
                    <label>Tenure</label>
                    <select value={tenure} className={tenureError ? "salary-input error" : "salary-input"} onChange={handleTenure}>
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <div className="loan-in">
                      ...
                      />
                      <span className="textSize"> {monthlyIncome ? numberToText.convertToText(monthlyIncome, { language: "en-in" }) : ""}</span>
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <select value={salaryRecievedIn.toLowerCase()} className={salaryRecievedInError ? "salary-input error" : "salary-input"} onChange={handleSalaryRecieved}>
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <input type="text" className={emailError?"salary-input error":"salary-input"} value={email} onChange={handleEmail} placeholder="Your offcial email-id"/>
                  </div>
                  <div className="col-md-6 spacing">
                    <label>Total Experience</label>
                    <select value={experience} className={experienceError ? "salary-input error" : "salary-input"} onChange={handleExperience}>
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <select value={working} className={workingError ? "salary-input error" : "salary-input"} onChange={handleWorking}>
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <select value={np} className={npError ? "salary-input error" : "salary-input"} onChange={handleNp}>
            ...
            <>
              <div className="inner-employement">
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    <label>Name</label>
                    <input type="text" className={nameError ? "salary-input error" : "salary-input"} onChange={handleName} value={name} readOnly />
                  </div>
                  <div className="col-md-6 spacing">
                    <label>Date of birth</label>
                    <div className="loan-in">
                      <DatePicker className={dobError ? "salary-input error" : "salary-input"} onChange={handleDateOfBirth} selected={dob} dateFormat="dd/MM/yyyy" placeholderText="Date Of Birth" dropdownMode="select" showMonthDropdown showYearDropdown adjustDateOnChange disabled />
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    {panValidP?<i className="fa fa-check" style={{"position": "absolute","color": "green"}}></i>:""}
                    <span>{(panNumberCheckError ? <small className="alertMode">Invalid pan number</small> :"")}</span>
                    <span>{(!panNumberCheckError && panNumberExistError ? <small className="alertMode">Pan number already exists!</small> :"")}</span>
                  </div>
                  <div className="col-md-6 spacing">
                    <label>Aadhaar Number</label>
                    <InputMask mask="9999 9999 9999" maskChar="" className={panNumberError ? "salary-input error" : "salary-input"} placeholder="9999 9999 9999" onChange={handleAadhaar} value={aadhaar} />
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <select className={addOneError ? "salary-input error" : "salary-input"} value={relationshipStatus} onChange={handleRelationShipStatus}>
                  ...
                  <div className="col-md-6 spacing">
                    <label>Gender</label>
                    <select className={addOneError ? "salary-input error" : "salary-input"} value={gender.toLowerCase()} onChange={handleGender}>
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <input type="text" className={statePermanentError ? "salary-input error" : "salary-input"} placeholder="Enter City, District" value={cityCurrent} onChange={handleCityCurrent} />
                  </div>
                  <div className="col-md-6 spacing">
                    <label>State</label>
                ...
                <div className="form-group row">
                    <div className="col-md-12">
                      ...
                      <div><input type="checkbox" onChange={handleSameAddress}/> Check if Current Address is same as Permanent Address</div>
                    </div>
                </div>
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    <label>Addess 1</label>
                    <input type="text" className={addOnePermanentError ? "salary-input error" : "salary-input"} placeholder="Enter address 1" value={addOnePermanent} onChange={handleAddOnePermanent} />
                  </div>
                  <div className="col-md-6 spacing">
                    <label>Addess 2</label>
                    <input type="text" className={addTwoPermanentError ? "salary-input error" : "salary-input"} placeholder="Enter address 2" value={addTwoPermanent} onChange={handleAddTwoPermanent} />
                  </div>
                </div>
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    <label>Landmark</label>
                    <input type="text" className={streetPermanentError ? "salary-input error" : "salary-input"} placeholder="Enter landmark" value={streetPermanent} onChange={handleStreetPermanent} />
                  </div>
                  <div className="col-md-6 spacing">
                    <label>Pin code</label>
                    <InputMask mask="999999" type="tel" maskChar="" className={pinCodePermanentError ? "salary-input error" : "salary-input"} placeholder="Enter pin code" value={pinCodePermanent} onChange={handlePinCodePermanent} onKeyUp={(e) => getAddressByPin(e, "Permanent")} />
                  </div>
                </div>
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    <label>City, District</label>
                    <input type="text" className={statePermanentError ? "salary-input error" : "salary-input"} placeholder="Enter City, District" value={cityPermanent} onChange={handleCityPermanent} />
                  </div>
                  
                  <div className="col-md-6 spacing">
                    <label>State</label>
                    <input type="text" className={statePermanentError ? "salary-input error" : "salary-input"} placeholder="Enter state" value={statePermanent} onChange={handleStatePermanent} />
                  </div>
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        className={aadhaarFrontError ? "form-control errorlogin" : "form-control"}
                        ref={aadhaarFrontRef}
                      />
                      {aadhaarFront.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "aadhaarFront")}></i>:""}
                      {aadhaarFrontErrorMsg ? <span className="vrtext message">{panCardErrorMsg}</span> : ""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        className={aadhaarBackError ? "form-control errorlogin" : "form-control"}
                        ref={aadhaarBackRef}
                      />
                      {aadhaarBack.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "aadhaarBack")}></i>:""}
                      {aadhaarBackErrorMsg ? <span className="vrtext message">{panCardErrorMsg}</span> : ""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        ref={salaryFirstRef}
                      />
                      {salaryStatement.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "salaryFirst")}></i>:""}
                      {panCardErrorMsg ? <span className="vrtext message">{panCardErrorMsg}</span> : ""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        ref={salarySecondRef}
                      />
                      {salaryStatementP.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "salarySecond")}></i>:""}
                      {panCardErrorMsg ? <span className="vrtext message">{panCardErrorMsg}</span> : ""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        ref={salaryThirdRef}
                      />
                      {salaryStatementT.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "salaryThird")}></i>:""}
                      {panCardErrorMsg ? <span className="vrtext message">{panCardErrorMsg}</span> : ""}
