    			...
    			<div className="layout-container">
                  ...
                  <div className="authentic-add-user">
                    ...
                    <div className="row">
												...
												<div className="col-lg-6 col-md-6 col-sx-6">
													<div className="form-group">
                            <InputMask mask="999 999 9999" maskChar="" className="form-control" placeholder="Mobile Number(999 999 9999)"  />
                      ...
                      <div className="row">
											...
											<div className="row">
												...
												<div className="col-lg-6 col-md-6 col-sx-6">
													<button type="close" className="btn btn-secondary" >Close</button>&nbsp;
