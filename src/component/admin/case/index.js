...
const CaseNumberInLead = () => {
  ...
  const handleShow = () => { setShow(true); setEditModeOffer(0) };
  ...
  const handleCloseLoanAmount = () => { setShowLoanAmount(false) };
  const handleCloseEmployementDetails = () => { setShowEmployementDetails(false) };
  const handleClosePesonalDetails = () => { setPersonalDetails(false); setDoiError(false); setDobError(false); };

  const handleCloseBankDetails = () => { setBankDetailsShow(false) };
  const handleCloseDirectorDetails = () => { setDirectorShow(false) };
  const handleRemarksShow = () => { setShowRemarks(false) };
  ...
  const getUserData = () => {
    ...
    axios.post(API_URL + "admin/get-user-loan-appication", formData).then((res) => {
      let response = res.data;
      if (response?.status === 200) {
        ...
        if (Object.keys(resp).length) {
          ...
          let panData = resp?.files.filter(x => x.document_type === "pan_card")
          pancardFile = panData[0]?.path;

          let businessregData = resp?.files.filter(x => x.document_type === "business_registration")
          businessregDatas = businessregData[0]?.path;

          let bankStatementData = resp?.files.filter(x => x.document_type === "bank_statement")
          ...
          let partnershipDeedData = resp?.files.filter(x => x.document_type === "partnership_deed")
          partnershipDeed = partnershipDeedData[0]?.path;


          let aadhaarFrontData = resp?.files.filter(x => x.document_type === "aadhaar_front")
          aadhaarFront = aadhaarFrontData[0]?.path;


          let directorKycData = resp?.files.filter(x => x.document_type === "director_kyc")
          directorKyc = directorKycData[0]?.path;

          let aadhaarBackData = resp?.files.filter(x => x.document_type === "aadhaar_back")
          aadhaarBack = aadhaarBackData[0]?.path;

          let salData = resp?.files.filter(x => x.document_type === "salary_slip")
        ...
        let created_by = "";
        if (resp?.user_detail?.user_id == resp?.loan_requirement?.created_by || resp?.loan_requirement?.created_by == null || resp?.loan_requirement?.created_by == "admin") {
          created_by = "FinLab";
        } else {
          created_by = "Partner";
        }

        setloanTypeData(resp?.loan_requirement?.purpose_of_loan_name ? resp?.loan_requirement?.purpose_of_loan_name : "");
        setApplicantEmail(resp?.personal_detail?.email_id ? resp?.personal_detail?.email_id : "");
        setApplicantName(resp?.personal_detail?.name ? resp?.personal_detail?.name : "");

        let bankDetailsOffers = resp?.bank_details ? resp?.bank_details : []

        if (bankDetailsOffers.length) {
          let offerAcept = bankDetailsOffers.map(x => { return x.offer_id });
        ...
        setPh(resp?.user_detail?.case_number ? resp?.user_detail?.case_number : "0000000000")
        setIsVerified(resp?.is_verified > 0 ? true: false);

        setData([{
          is_pan_verified: resp?.verified_data?.is_pan_verified?true:false,
          is_gstin_verified: resp?.verified_data?.is_gstin_verified?true:false,
          name: resp?.personal_detail?.name ? resp?.personal_detail?.name : "",
          caseNumber: resp?.user_detail?.case_number ? resp?.user_detail?.case_number : "",
          emailId: resp?.personal_detail?.email_id ? resp?.personal_detail?.email_id : "",
          phoneNumber: resp?.user_detail?.mobile_number ? resp?.user_detail?.mobile_number : "",
          loanAmountRequired: resp?.loan_requirement?.loan_required_amount ? resp?.loan_requirement?.loan_required_amount : "",
          loanType: resp?.loan_requirement?.purpose_of_loan_name ? resp?.loan_requirement?.purpose_of_loan_name : "",
          appliedDate: resp?.loan_requirement?.created_at ? resp?.loan_requirement?.created_at : "",
          offerAdded: response?.respData?.user_detail?.active_offer_id ? "Yes" : "No",
          source: created_by ? created_by : "",
          loanId: resp?.loan_requirement?.id ? resp?.loan_requirement?.id : "",
          loanPurposeId: resp?.loan_requirement?.purpose_of_loan ? resp?.loan_requirement?.purpose_of_loan : "",
          loanPurpose: resp?.loan_requirement?.purpose_of_loan_name ? resp?.loan_requirement?.purpose_of_loan_name : "",
          subLoanPurposeId: resp?.loan_requirement?.sub_loan_of_purpose ? resp?.loan_requirement?.sub_loan_of_purpose : "",
          subLoanPurpose: resp?.loan_requirement?.sub_loan_of_purpose_name ? resp?.loan_requirement?.sub_loan_of_purpose_name : "",
          loanDuration: resp?.loan_requirement?.loan_duration ? resp?.loan_requirement?.loan_duration : "",
          personalDetailsId: resp?.personal_detail?.id ? resp?.personal_detail?.id : "",
          businessTypeId: resp?.personal_detail?.business_type ? resp?.personal_detail?.business_type : "",
          businessType: resp?.personal_detail?.business_type_name ? resp?.personal_detail?.business_type_name : "",
          panNumber: resp?.personal_detail?.pan_card ? resp?.personal_detail?.pan_card : "",
          dateOfBirth: resp?.personal_detail?.dob_doi ? resp?.personal_detail?.dob_doi : "",
          othersBusinessName: resp?.personal_detail?.other_business ? resp?.personal_detail?.other_business : "",
          subBusinessName: resp?.personal_detail?.sub_business_type_name ? resp?.personal_detail?.sub_business_type_name : "",
          subBusinessId: resp?.personal_detail?.sub_business_type ? resp?.personal_detail?.sub_business_type : "",
          dateOfIncorporation: resp?.personal_detail?.doi ? resp?.personal_detail?.doi : "",
          companyName: resp?.salaried_detail?.company_name ? resp?.salaried_detail?.company_name : "",
          companyAddress: {
            address1: resp?.personal_detail?.permanant_address_1 ? resp?.personal_detail?.permanant_address_1 : "",
            address2: resp?.personal_detail?.permanant_address_2 ? resp?.personal_detail?.permanant_address_2 : "",
            landmark: resp?.personal_detail?.permanant_landmark ? resp?.personal_detail?.permanant_landmark : "",
            pincode: resp?.personal_detail?.permanant_pin_code ? resp?.personal_detail?.permanant_pin_code : "",
            state: resp?.personal_detail?.permanant_state ? resp?.personal_detail?.permanant_state : "",
            city: resp?.personal_detail?.permanant_city ? resp?.personal_detail?.permanant_city : "",
          },
          pastLoan: resp?.personal_detail?.past_loan ? resp?.personal_detail?.past_loan : "",
          pastLoanAmount: resp?.personal_detail?.past_loan_amount ? resp?.personal_detail?.past_loan_amount : 0,
          empId: resp?.self_employee_detail?.id ? resp?.self_employee_detail?.id : "",
          gstinNumber: resp?.self_employee_detail?.gstin ? resp?.self_employee_detail?.gstin : "",
          i_file: resp?.self_employee_detail?.i_file ? resp?.self_employee_detail?.i_file : "",
          itrAvailabilityId: resp?.self_employee_detail?.is_itr_available ? resp?.self_employee_detail?.is_itr_available : "",
          itrAvailability: resp?.self_employee_detail?.is_itr_available ? 'Last ' + resp?.self_employee_detail?.is_itr_available + ' Yr' : "",
          businessVintageId: resp?.self_employee_detail?.business_vintage ? resp?.self_employee_detail?.business_vintage : "",
          businessVintage: resp?.self_employee_detail?.business_vintage ? resp?.self_employee_detail?.business_vintage + ' Yr' : "",
          turnoverYearly: resp?.self_employee_detail?.annual_turnover ? resp?.self_employee_detail?.annual_turnover : "",
          grossProfit: resp?.self_employee_detail?.gross_Annual_profit ? resp?.self_employee_detail?.gross_Annual_profit : "",
          industryName: resp?.self_employee_detail?.industry_name ? resp?.self_employee_detail?.industry_name : "",
          industry: resp?.self_employee_detail?.industry ? resp?.self_employee_detail?.industry : "",
          subIndustry: resp?.self_employee_detail?.sub_industry ? resp?.self_employee_detail?.sub_industry : "",
          subIndustryName: resp?.self_employee_detail?.sub_industry_name ? resp?.self_employee_detail?.sub_industry_name : "",
          uploadPancard: pancardFile ? pancardFile : "",
          uploadBusinessRegistration: businessregDatas ? businessregDatas : "",
        ...
        if (type == 2 || type == 4) {
          if (resp?.offers.length) {
            let xdata = resp?.offers.filter((x) => { if (x.id == offerId) { return x } });
        ...
        let offered_bank = resp?.offers ? resp?.offers.map(x => { return (x.bank_name) }) : ["x"]
  ...
  const processData = (bank, loanAmt, emi, roi, tenure, processingFee, roiType) => {
    const jsonData = {
      "caseId": caseID,
      "bankId": bank,
      "loanAmt": loanAmt,
  ...
  const submitData = () => {
    ...
    axios.post(API_URL + "admin/save-user-offer", jsonData).then((res) => {
      let response = res.data;
  ...
  const changeStatus = (id, status) => {
    ...
    axios.post(API_URL + "admin/update-offer-status", dataForm).then((res) => {
      let response = res.data;
      if (response?.status === 200) {
        toast.success(response?.message);
        getUserData();
  ...
  const handleVerifyPanGstin = () => {
    ...
    axios.post(API_URL + "api-auth/verify-pan-gstin", formData).then((res) => {
      let response = res.data;
      if (response?.status === 200) {
        toast.success(response?.message);
        getUserData()
  ...
  const diclineApplication = () => {
    ...
    axios.post(API_URL + "admin/decline-application", jsonData).then((res) => {
      let response = res.data;
      if (response?.status === 200) {
        toast.success(response?.message);
        navigate("/admin/lead-case");
  ...
  const UpdateLoanAmountData = () => {
    if(handleLoanAmountValidation()){
      ...
      axios.post(API_URL + "admin/update-user-loan-data", jsonData).then((res) => {
  ...
  const sendWelcomeNote = () => {
    ...
    axios.post(API_URL + "admin/save-welcome-note-data", formData).then((res) => {
      let response = res.data;
  ...
  const UpdateEmployementDetailsData = () => {
   if(handleEmployeeValidation()){
    ...
    axios.post(API_URL + "admin/update-self-employee-detail-data", jsonData).then((res) => {
      let response = res.data;
  ...
  const UpdatePersonalDetailsData = () => {
    if (handleValidationPersonalDetails()) {
      ...
      axios.post(API_URL + "admin/update-user-profile-data", jsonData).then((res) => {
        let response = res.data;
  ...
  const UpdateBankInfoData = () => {
    if (handleBankValidation()) {
      ...
      axios.post(API_URL + "admin/update-user-bank-detail-data", jsonData).then((res) => {
        let response = res.data;
  ...
  const UpdateNoOfDirectos = (caseID) => {
    let formData = new FormData()
    formData.append('case_id', caseID);
    axios.post(API_URL + "director/update-no-of-director", formData).then((res) => {
      let response = res.data;
  ...
  const UpdateDirectorInfoData = () => {
    if (handleDirectorValidation()) {
      if (dirId) {
        ...
        axios.post(API_URL + "admin/update-director-detail-data", formData).then((res) => {
          let response = res.data;
        ...
        axios.post(API_URL + "director/save", formData).then((res) => {
          let response = res.data;
  ...
  const getRemarks = () => {
    ...
    axios.post(API_URL + "admin/get-agent-remark", jsonData).then((res) => {
  ...
  const AddRemarks = () => {
    if (handleRemarksValidation()) {
      ...
      axios.post(API_URL + "admin/add-agent-remark", jsonData).then((res) => {
        let response = res.data;
  ...
  const convertIntoZip = async () => {
    setLoader(true);
    var zip = new JSZip();
    let ds = await axios.post(API_URL + "zip-file", { "case_id": caseID }).then((res) => {
    ...
    for (let i = 0; i < ds.length; i++) {
      const base64Response = await fetch(`data:image/jpeg;base64,${ds[i].bufferData}`).then((res) => {
        return res;
  ...
  const handleDocumentsValidation = () => {
    ...
    if (panFile.length || bussnessDoc.length || bankStatement.length || formSixteen.length || formSixteenP.length || directorKYC.length || partnershipDeed.length) {
      isFormValid = true;
    } else {
      isFormValid = false;
    }
  ...
  const [directorAadharFrontErrorMsg, setDirectorAadharFrontErrorMsg] = useState("");
  const [directorAadharFrontError, setDirectorAadharFrontError] = useState(false);
  ...
  const [directorAadharBackErrorMsg, setDirectorAadharBackErrorMsg] = useState("");
  ...
  const verifyPancardNo = (pan) =>{
    ...
    const [panNumberDirectorCheckError,setPanNumberDirectorCheckError] = useState("");
  ...
  const checkPanNumber = (e) => {
    axios.post(API_URL+"user/check-user-pan",{pan: e, case_id: caseID}).then((res) => {
      setLoader(false)
      let response = res.data;
  ...
  const verifyGstNo = (gst) =>{
    ...
    axios.post(API_URL+"api-auth/verify-gst-number",jsonFormData).then((res) => {
      if(res?.data?.data!=undefined){
        let response = res.data;
        if((nameOnPan.trim()).replace(/ /g,'') == ((response?.data?.result?.gstnDetailed?.legalNameOfBusiness).trim()).replace(/ /g,'')){
...
const validatePanNumber = (e) => {
  if(validatePAN(e.target.value)){
    axios.post(API_URL+"api-auth/verify-pan-number-v3",{pan :e.target.value}).then((res) => {
      if(res?.data?.data!=undefined){
        let response = res.data;
        setNameError(false)
        setName(response?.data?.result?.name)
  ...
  return (
    <>
            ...
            <div className='mainContent'>
              ...
              {loader ? <Loader display={"flex"} /> :
                <div className="main-body">
                  ...
                  <button className='btn-warning' style={{ height: '2rem' }} onClick={handleBackButton}><i className='fa fa-arrow-left' aria-hidden="true"></i></button>
                    {
                      (isVerified == 0 && type == 1)?<><span> <button className="btn btn-warning" onClick={handleVerifyPanGstin}>Verify PAN/GSTIN</button></span></>:""
                    }
                    
                    <span> <button className="btn btn-primary" onClick={handleUploadDocOpen} disabled={isDisableAll} >Upload Documents</button></span>
                    <span> <button className="btn btn-secondary" onClick={handleShowRemarks} >Add Remarks</button></span>
                    
                    {(type == 1) ?
                      <>
                        <span> <button onClick={(e) => { generateData(data) }} className="btn btn-primary" disabled={!isVerified?"disabled":""}><i className="fa fa-download" aria-hidden="true"></i> Application</button></span>
                        <span> <button onClick={convertIntoZip} className="btn btn-primary" disabled={!isVerified?"disabled":""}><i className="fa fa-download" aria-hidden="true"></i> Documents</button> </span>
                        <span> <button className="btn btn-primary" onClick={handleShow} disabled={!isVerified?"disabled":""}>Add Offer</button></span>
                        <span> <button className="btn btn-warning" onClick={handleDecline}>Declined</button></span>
                      </>
                      : ""}
                    {(type == 2 || type == 4) ?
                      <span> <button className="btn btn-warning" disabled={isWelcomeData} onClick={handleShowOffer}>Welcome Letter</button></span>
                      :
                      ""
                    }
                  </div>
                        ...
                        <div className="card-body">
                          <div className='row'>
                            ...
                            <div className="row ">
                              ...
                              <div className="col-sm-8 text-secondary"> {v.caseNumber}</div>
                            </div>   
                            <div className="row ">
                              <div className="col-sm-4" >
                                <h6>Status:</h6>
                              </div>
                              <div className="col-sm-8 text-secondary"> ---</div>
                            </div>   
                            <div className="row ">
                              <div className="col-sm-4" >
                                <h6>Source:</h6>
                              </div>
                              <div className="col-sm-8 text-secondary"> {v.source}</div>
                            </div>                           
                            </div>
                            <div className='col-md-6'>
                            <div className="row ">
                              ...
                              <div className="col-sm-6 text-secondary">{v.appliedDate ? moment(v.appliedDate, "YYYY-MM-DD hh:mm:ss").format("DD/MM/YYYY") : ""}</div>
                            </div>  
                            <div className="row ">
                              <div className="col-sm-6" >
                                <h6>Last updated date:</h6>
                              </div>
                              <div className="col-sm-6 text-secondary">---</div>
                            </div>  
                              <div className="row ">
                              <div className="col-sm-6" >
                                <h6>Agent Name:</h6>
                        ...
                        <div className="card-body">
                          <div className='row'>
                            ...
                            <div className="row ">
                              ...
                              <div className="col-sm-5 text-secondary"> {v.loanAmountRequired ? <CurrencyFormat value={v.loanAmountRequired} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</div>
                              
                              <button className="btn" style={{padding:'0px'}} onClick={(e) => { editLoanAmount(v) }} disabled={isDisableAll} >
                            ...
                            <div className="row ">
                              ...
                              <div className="col-sm-6 text-secondary"> {v.loanPurpose}</div>
                            </div>
                            ...
                            <div className="row ">
                              ...
                              <div className="col-sm-6 text-secondary"> {v.subLoanPurpose}</div>
                            </div>
                            ...
                            <div className="row ">
                              ...
                              <div className="col-sm-6 text-secondary"> {v.loanDuration ? v.loanDuration + " Year(s)" : ""}</div>
                            </div>
                            </div>
                          </div>
                            ...
                            <div className='row'>
                              <div className='col-md-6'>
                                <div className="row ">
                                  ...
                                  <div className="col-sm-5 text-secondary">{v.businessType ? v.businessType : ""}</div>

                                  <button className="btn" style={{ padding: '0px' }} onClick={(e) => { editPersonalDetails(v) }} disabled={isDisableAll} ><i className="fa fa-edit" aria-hidden="true"></i></button>
                                </div>
                                {(v.businessType === "Professional" || v.businessType === "Other") && (
                                  <div className="row">
                                    <div className="col-sm-6">
                                      <h6>Profession:</h6>
                                    </div>
                                    <div className="col-sm-5 text-secondary">{(v.businessType === "Professional" )?v?.subBusinessName:v?.othersBusinessName}</div>
                                  </div>
                                )}
                                ...
                                <div className="row" >
                                  ...
                                  <div className="col-sm-6 text-secondary">{v.name ? v.name : ""}</div>
                                </div>
                                ...
                                <div className="row" >
                                  ...
                                  <div className="col-sm-6 text-secondary">{v.panNumber ? v.panNumber : ""} &nbsp;{v?.is_pan_verified ? <img src={verifiedImage} alt="verified" style={{ "height": "13px" }} /> : ""}</div>
                                </div>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-sm-6 text-secondary">{v.dateOfBirth ? moment(v.dateOfBirth, "YYYY-MM-DD hh:mm:ss").format("DD/MM/YYYY") : ""}</div>
                                </div>
                                ...
                                <div className="row" >
                                  ...
                                  <div className="col-sm-6 text-secondary">{v.dateOfIncorporation ? moment(v.dateOfIncorporation, "YYYY-MM-DD hh:mm:ss").format("DD/MM/YYYY") : ""}</div>
                                </div>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-sm-6 text-secondary">
                                    {v.companyAddress.address1 ? v.companyAddress.address1 + ", " : ""}{v.companyAddress.address2 ? v.companyAddress.address2 + ", " : ""}{v.companyAddress.landmark ? v.companyAddress.landmark + ", " : ""}
                                ...
                                <div className="row" >
                                  ...
                                  <div className="col-sm-6 text-secondary">{(v.pastLoan != "undefined") ? v?.pastLoan : ""}</div>
                                </div>
                                <div className="row" >
                                  <div className="col-sm-6">
                                    <h6>EMI you are paying currently :</h6>
                                  </div>
                                  <div className="col-sm-6 text-secondary">{v.pastLoanAmount && v.pastLoan == "Yes" ? <CurrencyFormat value={v.pastLoanAmount} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</div>
                              ...
                              <div className='col-md-6'>
                                <div className="row" >
                                  ...
                                  <div className="col-sm-6 text-secondary">{v.i_file ? (v.i_file).toUpperCase() : "-"}</div>
                                  <button className="btn" style={{ padding: '0px' }} onClick={(e) => { editEmployementDetails(v) }} disabled={isDisableAll} ><i className="fa fa-edit" aria-hidden="true"></i></button>
                                </div>
                                <span style={{ "display": (v.i_file == "none" ? "none" : "") }}>
                                  <div className="row" style={{ "display": ((v.i_file == "both" || v.i_file == "gstin") ? "" : "none") }}>
                                    <div className="col-sm-5">
                                      <h6>GSTIN number:</h6>
                                    </div>
                                    <div className="col-sm-6 text-secondary">{v.gstinNumber} &nbsp;{v.is_gstin_verified ? <img src={verifiedImage} alt="verified" style={{ "height": "13px" }} /> : ""}</div>

                                  </div>

                                  <div className="row" style={{ "display": ((v.i_file == "both" || v.i_file == "itr") ? "" : "none") }}>
                                    <div className="col-sm-5">
                                      <h6>Itr availability:</h6>
                                    </div>
                                    <div className="col-sm-7 text-secondary">{v.itrAvailability}</div>
                                  </div>
                                </span>
                                <div className="row" >
                                  <div className="col-sm-5">
                                  ...
                                  <div className="col-sm-7 text-secondary">{(v.businessVintageId == "1") ? "> 2 Yr" : (v.businessVintageId == "2") ? "2-3 Yr" : (v.businessVintageId == "3") ? "3+ Yrs." : ""}</div>
                                </div>
                                ...
                                <div className="row" >
                                  ...
                                  <div className="col-sm-7 text-secondary">{v.turnoverYearly ? <CurrencyFormat value={v.turnoverYearly} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</div>
                                </div>
                                <div className="row" >
                                  <div className="col-sm-5">
                                    <h6>Gross annual profit:</h6>
                                  </div>
                                  <div className="col-sm-7 text-secondary">{v.grossProfit ? <CurrencyFormat value={v.grossProfit} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</div>
                                </div>
                                <div className="row" >
                                  <div className="col-sm-5">
                                    <h6>Industry:</h6>
                                  </div>
                                  <div className="col-sm-7 text-secondary">{(v.industryName) ? v.industryName : v.industry}</div>
                                </div>
                                <div className="row" >
                                  <div className="col-sm-5">
                                    <h6>Sub Industry:</h6>
                                  </div>
                                  <div className="col-sm-7 text-secondary">{(v.subIndustryName) ? ((v.industry == 15) ? v.subIndustry : v.subIndustryName) : v.subIndustry}</div>
                                </div>
                    ...
                    <div className='col-md-12 mb-3'>
                          ...
                          <h5 className="case-heading">
                            ...
                            <div className="card-body">
                              ...
                              <div className='col-md-6'>
                              {v.uploadPancard ?
                                <p>Pancard document <Link to={API_URL + v.uploadPancard} download="#" target="_blank">Download</Link></p>
                                : ""
                              }
                              {v.uploadBusinessRegistration ?
                                <p>Business registration proof <Link to={API_URL + v.uploadBusinessRegistration} download='#' target="_blank">Download</Link></p>
                                : ""}
                              {v.uploadBankStatement ?
                                <p>12 Months bank statement <Link to={API_URL + v.uploadBankStatement} download="#" target="_blank">Download</Link></p>
                                : ""
                              }

                              {v.uploadAadhaarFront ?
                                <p>Aadhar Card Front <Link to={API_URL + v.uploadAadhaarFront} download="#" target="_blank">Download</Link></p>
                                : ""
                              }

                              {v.uploadAadhaarBack ?
                                <p>Aadhar Card Back <Link to={API_URL + v.uploadAadhaarBack} download="#" target="_blank">Download</Link></p>
                                : ""
                              }
                              </div>
                              <div className='col-md-6'>
                              {v.uploadDirectorKyc ?
                                <p>MOA/AOA <Link to={API_URL + v.uploadDirectorKyc} download="#" target="_blank">Download</Link></p>
                                : ""
                              }

                              {v.uploadPartnershipDeed ?
                                <p>Partnership Deed <Link to={API_URL + v.uploadPartnershipDeed} download="#" target="_blank">Download</Link></p>
                                : ""
                              }

                              {(v?.uploadSalarySlip.length) ? v?.uploadSalarySlip.map((k, j) => (
                                <p>Salary Slip <Link to={API_URL + k} download="#" target="_blank">Download</Link></p>
                              )) : ""}

                              {(v?.uploadItr.length) ? v?.uploadItr.map((k, j) => (
                                <p>ITR <Link to={API_URL + k} download="#" target="_blank">Download</Link></p>
                              )) : ""}
                    ...
                    <div className="col-md-12 mb-3">
                      ...
                      <h5 className='case-heading'>Director details</h5>
                        ...
                        <div className='custom-cardHead'>
                            ...
                            <button className="btn btn-primary" onClick={handleAddDirector} >Add Director</button>
                          </div>
                          <table style={{ width: '100%' }} className="table table-stripped">
                            <thead>
                              <tr>
                                ...
                                <th className="table-head">Aadhar Front Doc.</th>
                                <th className="table-head">Aadhar Back Doc.</th>
                            ...
                            <tbody>
                              {v.directorData?.length ? v.directorData.map((row, index) => (
                                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                                  <td className="table-body">{row.name}</td>
                                  <td className="table-body">{row.pan_card}</td>
                                  <td className="table-body">{row.aadhar_card ? <CurrencyFormat value={row.aadhar_card} displayType={'text'} format="#### #### ####" /> : ""}</td>
                                  <td className="table-body"> <Link to={API_URL + row.pan_doc_path} target="_blank" download="#">Download</Link> </td>
                                  <td className="table-body"> <Link to={API_URL + row.aadhar_front_doc_path} target="_blank" download="#">Download</Link>  </td>
                                  <td className="table-body"> <Link to={API_URL + row.aadhar_back_doc_path} target="_blank" download="#">Download</Link> </td>

                                  <td className="table-body">

                                    <button className="btn btn-primary" onClick={() => editDirectorDetails(row)} disabled={isDisableAll} ><i className="fa fa-edit" aria-hidden="true"></i></button>
                          ...
                          <table style={{ width: '100%' }} className="table table-stripped">
                            <thead>
                              <tr>
                                ...
                                <th className="table-head">Offer Created at</th>
                                <th className="table-head">Action</th>

                              </tr>
                            </thead>
                            <tbody>
                              {v.offerData?.length ? v.offerData.map((row, index) => (
                                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                                  <td className="table-body">{row.bank_name}</td>
                                  <td className="table-body">{row.disbursement_amount ? <CurrencyFormat value={row.disbursement_amount} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</td>
                                  <td className="table-body">{row.monthly_installment_amount ? <CurrencyFormat value={row.monthly_installment_amount} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</td>
                                  <td className="table-body">{row.rate_of_interest ? row.rate_of_interest + " %" : ""}</td>
                                  <td className="table-body">{row.tenure ? row.tenure + " Months" : ""}</td>
                                  <td className="table-body">{row.processing_fee ? <CurrencyFormat value={row.processing_fee} displayType={'text'} thousandSeparator={true} thousandSpacing={'2s'} prefix={'₹'} /> : ""}</td>
                                  <td className="table-body">{row.roi_type}</td>
                                  <td className="table-body">{row.created_at ? moment(row.created_at, "YYYY-MM-DD hh:mm:ss").format("DD/MM/YYYY") : ""}</td>
                                  {acceptedOffers.length && acceptedOffers.includes(row.id) ?
                                    <td className="table-body">
                                      <button className="btn btn-success" >Accepted Offer</button>
                                    </td>
                                    :
                                    <td className="table-body">
                                      {row.status ?
                                        <button className="btn btn-primary mr-2" onClick={() => changeStatus(row.id, 0)} disabled={isDisableAll} >Active</button>
                                        :
                                        <button className="btn  mr-2 btn-danger" onClick={() => changeStatus(row.id, 1)} disabled={isDisableAll} >InActive</button>
                                      }

                                      <button className="btn btn-primary" onClick={(e) => { editData(row) }} disabled={isDisableAll} ><i className="fa fa-edit" aria-hidden="true"></i></button>
                        ...
                        <h5 className='case-heading'>Bank details</h5>
                          <div className="card-body">
                            ...
                            <table style={{ width: '100%' }} className="table table-stripped">
                              ...
                              <tbody>
                                {v.bankDetails?.length ? v.bankDetails.map((row, index) => (
                                  <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                                    <td className="table-body">{row.account_number}</td>
                                    <td className="table-body">{row.account_holder_name}</td>
                                    <td className="table-body">{row.ifsc}</td>
                                    <td className="table-body">{row.branch_address}</td>
                                    <td className="table-body"> <Link to={API_URL + row.path} target="_blank" download="#">Download</Link> </td>
                                    {/*<td className="table-body">
                    ...
                    <h5 className='case-heading'>Remarks Details</h5>
                      <div className="card-body">
                        ...
                        <table style={{ width: '100%' }} className="table table-stripped">
                          ...
                          <tbody>
                            {remarksData?.length ? remarksData.map((row, index) => {

                              return (
                                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                                  <td className="table-body">{row.remark}</td>
                                  <td className="table-body">{row.created_at ? moment.utc(row.created_at, "YYYY-MM-DD hh:mm:ss").local().format("DD/MM/YYYY hh:mm:ss A") : ""}</td>
      ...
      >
        ...
        <Modal.Body>
          <AddOffer bankData={bankData} processData={processData} checkSubmitDisableBtn={checkSubmitDisableBtn} previousData={previousData} loanTypeData={loanTypeData} edit={editModeOffer} dataOfOffer={dataOfOffer} />
        </Modal.Body>
        <Modal.Footer>
      ...
      >
        ...
        <Modal.Body>
          <WelComeNote offerData={getSelectedOfferData} welcomeProcessData={welcomeProcessData} checkWelcomSubmitDisableBtn={checkWelcomSubmitDisableBtn} />
        </Modal.Body>
        <Modal.Footer>
          <Button variant="secondary" onClick={handleCloseOffer}>
            Close
          </Button>
          <Button variant="primary" disabled={submitWelcomeDisable} onClick={sendWelcomeNote}  >Submit</Button>
        </Modal.Footer>
      </Modal>
      ...
      >
              ...
              <div className="inner-employement">
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <select value={loanPurpose} className={"salary-input"} onChange={(e) => { handleLoanPurpose(e) }} disabled={true}>
                      <option value="">Select Loan Purpose</option>
                      {loanData ? loanData.map(xx => {
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <select value={subLoanPurpose} className={subLoanPurposeError ? "salary-input error" : "salary-input"} onChange={(e) => { handleSubLoanPurpose(e) }} >
                      <option value="">Sub Loan Purpose</option>
                      {subLoanPurposeData ? subLoanPurposeData.map(xx => {
                        return (<option value={xx?.id}>{xx?.name}</option>)
                      })
                        : ""}
                    </select>
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <InputMask mask="9999" maskChar="" name={"tenure"} className={loanDurationError ? "salary-input error" : "salary-input"} value={loanDuration} placeholder="72 Months" onChange={(e) => { handleDuration(e) }} />
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={UpdateLoanAmountData}  >Submit</Button>
        </Modal.Footer>
      </Modal>
              ...
              <div className="inner-employement">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <div className="loan-in">
                      <label className="radio-inline">
                        <input type="radio" name="i_file" value="both" onClick={handleIfile} checked={iFile=="both"?true:false} /> BOTH
                      </label> &nbsp; &nbsp;
                      <label className="radio-inline">
                        <input type="radio" name="i_file" value="gstin" onClick={handleIfile} checked={iFile=="gstin"?true:false}/> GSTIN
                      </label> &nbsp; &nbsp;
                      <label className="radio-inline">
                        <input type="radio" name="i_file" value="itr" onClick={handleIfile} checked={iFile=="itr"?true:false}/> ITR
                      </label> &nbsp; &nbsp;
                      <label className="radio-inline">
                        <input type="radio" name="i_file" value="none" onClick={handleIfile} checked={iFile=="none"?true:false}/> NONE
                      </label>

                    </div>
                    </div>
                  </div>
                  <div className="form-group loan-in row" style={{"display":(iFile=="none"?"none":"")}}>
                  <div className="col-md-6 spacing" style={{"display":((iFile=="gstin" || iFile=="both")?"":"none")}}>
                    <label>GSTIN Number</label>
                    <div className="loan-in">
                      <InputMask mask="99aaaaa9999a9a*" maskChar="" className={gstinError ? "salary-input error" : "salary-input"} placeholder="22AAAAA0000A1Z5" value={gstin} onBlur={valideGSTIN} onChange={handleGstin} />
                      {gstinVerified?<i className="fa fa-check" style={{"position": "absolute","color": "green"}}></i>:""}
                      <span>{(gstinCheckError ? <small className="alertMode">This GSTIN is not match with PAN!</small> :"")}</span>
                    </div>

                  </div>
                  <div className="col-md-6 spacing" style={{"display":((iFile=="itr" || iFile=="both")?"":"none")}}>
                    <label>Itr Availability</label>
                    <select value={itrAvailable} className={itrAvailableError ? "salary-input error" : "salary-input"} onChange={handleItrAvailable} >
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <select value={businessVintage} className={businessVintageError ? "salary-input error" : "salary-input"} onChange={handleBusinessVintage}>
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <select value={industry} className={industryError ? "salary-input error" : "salary-input"} onChange={(e) => { handleIndustry(e) }}>
                      <option value="">Select Industry</option>
                      {industryData ? industryData.map(xx => {
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <select value={subIndustry} className={subIndustryError ? "salary-input error" : "salary-input"} onChange={(e) => { handleSubIndustry(e) }}>
                      <option value="">Select Sub Industry</option>
                      {subIndustryData ? subIndustryData.map(xx => {
          ...
          <div className="col-md-12 col-lg-12">
              ...
              <div className="inner-employement">
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <div className="loan-in">
                      <select className={businessTypeError ? "salary-input error" : "salary-input"} value={businessType} onChange={handleBusinessType}>
            ...
            <div className="col-md-6 spacing">
              ...
              <div className="loan-in">
                {businessType == 5 ? (
                  <select
                    className={professionError ? "salary-input error" : "salary-input"}
                    value={profession}
                    onChange={handleProfession}
                  >
                    <option value="">Select Profession</option>
                    {ProfessionDataDropDown
                      .filter(v => { 
                  ...
                  <input
                    type="text"
                    className={othersBusinessNameError ? "salary-input error" : "salary-input"}
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <InputMask mask="aaaaa9999a" maskChar="" className={panNumberError ? "salary-input error" : "salary-input"} placeholder="AZSPT5997H" onChange={handlePanNumber} onKeyUp={validatePanNumber} value={panNumber} />
                  </div>
                  ...
                  {dobHide ? <div className="col-md-6 spacing">
                    <label>Date of birth</label>
                    <div className="loan-in">
                      <DatePicker className={dobError ? "salary-input error" : "salary-input"} onChange={handleDateOfBirth} selected={dob} dateFormat="dd/MM/yyyy" placeholderText="Date Of Birth" dropdownMode="select" showMonthDropdown showYearDropdown adjustDateOnChange maxDate={calculateMaxDate()} />
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <div className="loan-in">
                      <DatePicker className={doiError ? "salary-input error" : "salary-input"} onChange={handleDateOfInc} selected={doi} dateFormat="dd/MM/yyyy" placeholderText="Date Of Incorporation" dropdownMode="select" showMonthDropdown showYearDropdown adjustDateOnChange maxDate={new Date()} />
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    ...
                    <div className="row year-month">
                      <div className="col-md-12">
                        <select value={pastLoan} className={pastLoanError ? "salary-input error" : "salary-input"} onChange={handlePastLoan}>
                  ...
                  <div className="col-md-6 spacing" style={{ "display": (pastLoan == "Yes") ? "block" : "none" }}>
                    <label>EMI you are paying currently :</label>
                    <CurrencyInput
                      className={pastLoanAmountError ? "salary-input error" : "salary-input"}
                    ...
                    />
                    <span className="textSize"> {pastLoanAmount ? numberToText.convertToText(pastLoanAmount, { language: "en-in" }) : ""}</span>
                  </div>
      ...
      >
            ...
            <>
              <div className="inner-employement">
                ...
                <div className="form-group loan-in row">
                  <div className="col-md-6 spacing">
                    <label>Pan Number</label>
                    <InputMask mask="aaaaa9999a" maskChar="" className={dirPanNoError ? "salary-input error" : "salary-input"} placeholder="AZSPT5997H" onChange={handleDirPanNumber} value={dirPanNo} />
                    {panValid?<i className="fa fa-check" style={{"position": "absolute","color": "green"}}></i>:""}
                    <span>{(panNumberDirectorCheckError ? <small className="alertMode">Invalid pan number</small> :"")}</span>
                  </div>
                  <div className="col-md-6 spacing">
                    <label>Director Name</label>
                    <input type="text" className={dirNameError ? "salary-input error" : "salary-input"} onChange={handleDirName} value={dirName} readOnly />
                  </div>
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <InputMask mask="9999 9999 9999" maskChar="" type="tel" className={aadhaarError ? "salary-input error" : "salary-input"} placeholder="9999 9999 9999" value={aadhaar} onChange={handleAadhaar} />
                    {aadhaarValid?<i className="fa fa-check" style={{"position": "absolute","color": "green"}}></i>:""}
                    <span>{(aadhaarNumberCheckError ? <small className="alertMode">Invalid aadhaar number</small> :"")}</span>
                  </div>
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <input
                      ...
                      className={directorPanCardError ? "form-control errorlogin" : "form-control"}
                    />
                    {directorPanCardErrorMsg ? <span className="vrtext message">{directorPanCardErrorMsg}</span> : ""}
                  </div>
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <input
                      ...
                      className={directorAadharFrontError ? "form-control errorlogin" : "form-control"}
                    />
                    {directorAadharFrontErrorMsg ? <span className="vrtext message">{directorAadharFrontErrorMsg}</span> : ""}
                  </div>
                  ...
                  <div className="col-md-6 spacing">
                    ...
                    <input
                      ...
                      className={directorAadharBackError ? "form-control errorlogin" : "form-control"}
                    />
                    {directorAadharBackErrorMsg ? <span className="vrtext message">{directorAadharBackErrorMsg}</span> : ""}
                  </div>
                </div>
              </div>
            </>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={UpdateDirectorInfoData}  >Submit</Button>
        </Modal.Footer>
      </Modal>
      ...
      >
              ...
              <div className="inner-employement">
                ...
                <div className="form-group loan-in row">
                  ...
                  <div className="col-md-12 spacing">
                    <label>Remarks:</label>
                    <input type="text" className={remarkError ? "salary-input error" : "salary-input"} onChange={handleRemarksData} value={remark} />
                  </div>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={AddRemarks}  >Submit</Button>
        </Modal.Footer>
      </Modal>
      ...
      >
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        className={panCardError ? "form-control errorlogin" : "form-control"}
                        ref={panRef}
                      />
                      {panFile.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "pan")}></i>:""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        className={bisinessTypeDocError ? "form-control errorlogin" : "form-control"}
                        ref={businessRef}
                      />
                      {bussnessDoc.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "businessDoc")}></i>:""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        accept="application/pdf"
                        //placeholder="Upload welcome note"
                        className={bankStatementError ? "form-control errorlogin" : "form-control"}
                        onChange={handleBankStatement}
                        ref={bankRef}
                      />
                      {bankStatement.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "bankStatement")}></i>:""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        className={formSixteenError ? "form-control errorlogin" : "form-control"}
                        ref={sixteenRef}
                      />
                      {formSixteen.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "formSixteen")}></i>:""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        className={formSixteenPError ? "form-control errorlogin" : "form-control"}
                        ref={sixteenRefP}
                      />
                      {formSixteenP.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "formSixteenP")}></i>:""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        accept="application/pdf"
                        // placeholder="Upload welcome note"
                        className={directorKYCError ? "form-control errorlogin" : "form-control"}
                        onChange={handleDirectorKYC}
                        ref={dirRef}
                      />
                      {directorKYC.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "directorKYC")}></i>:""}
                  ...
                  <div className="row multiuploads" >
                    ...
                    <div className="col-sm-7 text-secondary">
                      <input
                        ...
                        className={partnershipDeedError ? "form-control errorlogin" : "form-control"}
                        ref={deedRef}
                      />
                      {partnershipDeed.length?<i className="fa fa-times fa-times-red" onClick={(e) => removeFile(e, "partnershipDeed")}></i>:""}
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={handleUploadDocument}  >Submit</Button>
        </Modal.Footer>
      </Modal>
