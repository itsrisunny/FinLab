...
const IncompleteLeadCase = () => {
    ...
    // console.log(jsonData);
      ...
      axios.post(API_URL+`admin/all-applied-incomplete-loan-data`,jsonData).then((res) => {
    ...
    const getIndividualData =(caseId)=>{
      navigate('/admin/personal/case-detail/'+caseId+'/0/0');
    }
									...
									<div className="tableLeadCase">
                                      ...
                                      <label>
                                        ...
                                        <thead>
                                            ...
                                            <th className="table-head">Last Active Date</th>
