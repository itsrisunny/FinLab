...
const LeadCase = () => {
    ...
    // console.log(jsonData);
      ...
      axios.post(API_URL+`admin/all-applied-loan-data`,jsonData).then((res) => {
    ...
    const getIndividualData =(caseId)=>{
      navigate('/admin/personal/case-detail/'+caseId+'/1/0');
    }
    ...
    const SourceFilterChange = (e) =>{
      setSourceFilter(e.target.value);
      getLoanData(0);
    }
  
    const offerFilterChange = (e) =>{
