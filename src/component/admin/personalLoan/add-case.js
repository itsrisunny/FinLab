...
export default function AddCase(){
	...
	const checkPanNumber = (e) => {
		setLoader(true)
		axios.post(API_URL+"user/check-user-pan",{pan: e, case_id: "", loanPurpose:"2"}).then((res) => {
		  	setLoader(false)
		  	let response = res.data;
											...
											<div className="row">
												<div className="col-lg-6 col-md-6 col-xs-6">
													<div className="form-group">
														...
														<select className="form-control" value={loanPurpose} value="2" onChange={handleLoanPurpose} disabled>
