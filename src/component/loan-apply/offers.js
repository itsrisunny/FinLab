...
export default function offers({activeCard, resData,preFillData}){
	
	return(
		<>    
			<div className="col-lg-9 col-md-12" style={{display:(activeCard === "congratulation" && preFillData )?"block":"none"}}>
