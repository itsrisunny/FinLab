...
function App() {
    ...
    <BrowserRouter>   
        <Routes>
            ...
            <Route path="/dashboard/myProfile" element={<MyProfile />} exact={true} />
            <Route path="/dashboard/myDocument" element={<MyDocument />} exact={true} />
            <Route path="/dashboard/myApplication" element={<MyApplication />} exact={true} />            
            ...
            <Route path="/admin/dashboard" element={<AdminDashboard />} exact={true} />
            <Route path="/admin/lead-case" element={<AdminLeadCase />} exact={true} /> 
            <Route path="/admin/add-bank" element={<AddBank />} exact={true} />
            <Route path="/admin/case-detail/:caseID/:type/:offerId" element={<CaseDetail />} exact={true} />
            <Route path="/admin/offered-case" element={<AdminOfferedCase />} exact={true} />
            ...
            <Route path="/admin/personal/add/case" element={<AdminPersonalAddCase />} exact={true} />
            <Route path="/admin/personal/incomplete-lead-case" element={<PerosnalIncLeadCase />} exact={true} />
            <Route path="/admin/personal/lead-case" element={<PerosnalLeadCase />} exact={true} />
            <Route path="/admin/personal/offered-case" element={<PerosnalOfferCase />} exact={true} />
            ...
            <Route path="/partners-admin/dashboard" element={<PartnersDashboards />} exact={true} />
            <Route path="/partners-admin/add-cases" element={<PartnerAddCases />} exact={true} />
            <Route path="/partners-admin/personal/add-cases" element={<PartnerPersonalAddCases />} exact={true} />
            <Route path="/partners-admin/view-partner-case-detail/:caseID/:type/:offerId" element={<PartnerViewIndividualCases />} exact={true} />
            <Route path="/partners-admin/add/case" element={<PartnerAddCase />} exact={true} />
